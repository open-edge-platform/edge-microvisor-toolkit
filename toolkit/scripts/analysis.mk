...
SODIFF_REPO_SOURCES="edge-base.repo"
SODIFF_REPO_SOURCES_EXTENDED="edge-base.repo"
else
SODIFF_REPO_SOURCES="edge-base.repo"
SODIFF_REPO_SOURCES_EXTENDED="edge-base.repo"
endif
...
$(SODIFF_REPO_FILE): $(SODIFF_OUTPUT_FOLDER)
	echo $(SODIFF_REPO_SOURCES) | sed -E 's:([^ ]+[.]repo):$(SPECS_DIR)/edge-repos/\1:g' | xargs cat > $(SODIFF_REPO_FILE)
...
$(SODIFF_REPO_FILE_EXTENDED): $(SODIFF_OUTPUT_FOLDER)
	echo $(SODIFF_REPO_SOURCES_EXTENDED) | sed -E 's:([^ ]+[.]repo):$(SPECS_DIR)/edge-repos/\1:g' | xargs cat > $(SODIFF_REPO_FILE_EXTENDED)
