...
if [ -d "${REPO_ROOT}/azurelinux" ]; then
    ...
    skip_list=("knem" "xpmem" "iser" "isert" "mlnx-ethtool" "mlnx-iproute2" "mlnx-tools" "azurelinux-image-tools" "azurelinux-release" "azurelinux-repos" "azurelinux-rpm-macros")
