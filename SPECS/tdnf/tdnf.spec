...
Patch1:         tdnf-default-release.patch
...
# link Intel key as expected VMWare Key in test files
ln -sf /etc/pki/rpm-gpg/INTEL-RPM-GPG-KEY /etc/pki/rpm-gpg/VMWARE-RPM-GPG-KEY
...
* Wed Feb 12 2024 Lee Chee Yang <chee.yang.lee@intel.com> - 3.5.8-9
- remove kernel-mshv from installonlypkgs

* Wed Feb 26 2025 Mun Chun Yep <mun.chun.yep@intel.com> - 3.5.8-8
- Update symlink to Intel gpg key.

* Wed Feb 5 2024 Lee Chee Yang <chee.yang.lee@intel.com> - 3.5.8-7
