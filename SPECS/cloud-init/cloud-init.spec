...
python3 tools/render-template --variant edgemicrovisortoolkit > %{buildroot}/%{_sysconfdir}/cloud/cloud.cfg
...
* Tue Mar 25 2025 Naveen Saini <naveen.kumar.saini@intel.com> - 24.3.1-4
- refresh patch to fix a distro name issue.

* Thu Dec 19 2024 Mun Chun Yep <mun.chun.yep@intel.com> - 24.3.1-3
- Update vendor and distribution tag.

* Mon Nov 18 2024 Chee Yang Lee <chee.yang.lee@intel.com> - 24.3.1-2
- refresh patch for os variant. 
...
* Wed Oct 16 2024 Naveen Saini <naveen.kumar.saini@intel.com> - 24.2-3
- Change os variant to edgemicrovisortoolkit.

* Tue Oct 01 2024 Naveen Saini <naveen.kumar.saini@intel.com> - 24.2-2
- Add patch to add support for Edge Microvisor Toolkit
