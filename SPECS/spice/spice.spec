...
# Patches - Intel and Backport
Patch0001: 0001-common-Add-a-udev-helper-to-identify-GPU-Vendor.patch
Patch0002: 0002-server-add-SSL_OP_NO_RENEGOTIATION-fallback-path.patch
Patch0003: 0003-build-Remove-support-for-GStreamer-0.10.patch
Patch0004: 0004-gstreamer-encoder-Use-an-env-var-to-override-convert.patch
Patch0006: 0006-gstreamer-encoder-Use-a-h-w-based-encoder-with-Intel.patch
Patch0007: 0007-dcc-Check-to-see-if-the-client-supports-multiple-cod.patch
Patch0008: 0008-dcc-Create-a-stream-associated-with-gl_draw-for-non-.patch
Patch0009: 0009-dcc-send-Encode-and-send-gl_draw-stream-data-to-the-.patch
Patch0010: 0010-gstreamer-encoder-Add-an-encoder-function-that-takes.patch
Patch0011: 0011-video-stream-Don-t-stop-a-stream-associated-with-gl_.patch
Patch0012: 0012-gstreamer-encoder-Map-the-drm-format-to-appropriate-.patch
Patch0013: 0013-gstreamer-encoder-WA-to-overwrite-the-color-format.patch
Patch0014: 0014-dcc-Ensure-that-we-send-gl_draw_done-only-once.patch
Patch0015: 0015-red-qxl-Add-new-parameter-for-WA.patch
Patch0016: 0016-dcc-send-Fetch-the-hw_bypass-val-from-red-qxl-to-Vid.patch
Patch0017: 0017-WA-Remove-confusion-warning.patch
...
%changelog
* Thu Oct 29 2025 kintalix Jayanth <jayanthx.kintali@intel.com> - 0.15.2-1
