...
rm -rf src/modules/{users,finished,welcome,partition}
...
%setup -q -T -a 4 -D
#%setup -q -T -a 5 -D
for module in users finished welcome partition; do
...
mkdir -p %{buildroot}%{_datadir}/calamares/branding/EdgeMicrovisorToolkit/lang
lrelease-qt6 %{SOURCE41} -qm %{buildroot}%{_datadir}/calamares/branding/EdgeMicrovisorToolkit/lang/calamares-auto_fr.qm
lrelease-qt6 %{SOURCE42} -qm %{buildroot}%{_datadir}/calamares/branding/EdgeMicrovisorToolkit/lang/calamares-auto_de.qm
lrelease-qt6 %{SOURCE43} -qm %{buildroot}%{_datadir}/calamares/branding/EdgeMicrovisorToolkit/lang/calamares-auto_it.qm

install -p -m 644 %{SOURCE22} %{buildroot}%{_datadir}/calamares/branding/EdgeMicrovisorToolkit/show.qml
...
# EULA
#install -p -m 644 %{SOURCE53} %{buildroot}%{_sysconfdir}/calamares/emt-eula
...
%{_datadir}/calamares/branding/EdgeMicrovisorToolkit/stylesheet.qss
...
#%{_sysconfdir}/calamares/emt-eula
%{_sysconfdir}/calamares/settings.conf
%dir %{_datadir}/calamares/
%dir %{_datadir}/calamares/branding/
%dir %{_datadir}/calamares/branding/EdgeMicrovisorToolkit/
...
%changelog
* Fri Jan 30 2026 Lee Chee Yang <chee.yang.lee@intel.com> - 3.3.1-16
- update welcome message to match release version from os-release.
