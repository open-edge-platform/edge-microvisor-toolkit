...
BuildRequires:  cmake
BuildRequires:  spirv-llvm-translator-tools >= %{version}

%global libclc_srcdir libclc-%{version}.src
...
%changelog
* Thu Aug 28 2025 Swee Yee Fonn <swee.yee.fonn@intel.com> - 18.1.2-1
