...
%{!?emt:BuildRequires:  pkgconfig(gtk4) >= %{gtk4_version}}
...
%{!?emt:Conflicts:      gnome-terminal < 3.20.1-2}
...
%build
%meson --buildtype=plain -Ddocs=%{?with_docs:true}%{!?with_docs:false} -Dgtk3=true -Dgtk4=%{?emt:false}%{!?emt:true}
%meson_build
