...
All contributing Pull Requests should target the `3.0-dev` branch. This branche is used for
development, testing and validation before a periodic merge to the `3.0` release branch by
the project maintainers. The `3.0`, is the branch that is currently used for the publishing
the official releases of the EMT images.
