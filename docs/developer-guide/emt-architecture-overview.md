...
> in the relevant [SPEC file](../../SPECS/kernel/kernel.spec)
...
> Technology in the relevant [SPEC file](../../SPECS/kernel/kernel.spec)
...
[linuxptp](../../SPECS/linuxptp/linuxptp.spec), [ethtool](../../SPECS/ethtool/ethtool.spec)
and [xdp-tools](../../SPECS/xdp-tools/xdp-tools.spec). Click on any of the names to go to
